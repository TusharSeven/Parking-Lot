...
const userCommands = [
    ...
    },
    {
        ...
        description: '"park MH-01-HH-1234 White" will allocate the nearest slot from entry gate.'
    },
    {
        type: 'leave',
    ...
    },
    {
        ...
        description: '"registration_numbers_for_cars_with_colour White" will display the registration number of the cars of white color e.g. `MH-01-HH-1234, MH-01-BB-0001`'
    },
    {
    ...
    },
    {
        ...
        description: '"leave_car_by_registration_number MP-01-LT-0008" will free the slot occupied by car with registration number MP-01-LT-0008.'
    },
    {
